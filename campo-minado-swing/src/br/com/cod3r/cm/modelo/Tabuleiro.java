...
public class Tabuleiro {
    ...
    public void abrir(int linha, int coluna){
        try{
            ...
            // FIXME Ajsutar a implementação do método abir
    ...
    private void sortearMinas() {
        ...
        do {
            ...
            minasArmadas = campos.stream().filter(minado).count(); // como .count() retorna um long, mudei minasArmadas de int para long ao invés de fazer um casting aqui.
